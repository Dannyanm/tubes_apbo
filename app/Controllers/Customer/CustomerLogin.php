...
class CustomerLogin extends BaseController{
    ...
    public function login()
    {
        ...
        if($user) {
            if(password_verify($post['password'], $user->password)) {
                ...
                return redirect()->to(base_url('/customer/customerlogin'))->with('message_error', 'Password salah!');
            }
        } else {
            return redirect()->to(base_url('/customer/customerlogin'))->with('message_error', 'Username tidak ditemukan!');
        }
    }
