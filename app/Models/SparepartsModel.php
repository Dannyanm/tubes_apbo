...
class SparepartsModel extends Model
{
    ...
    protected $allowedFields = ['kode_spareparts', 'nama_spareparts', 'merek_spareparts', 'harga_spareparts', 'stok_spareparts', 'jenis_spareparts'];
